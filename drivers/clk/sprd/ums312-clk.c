...
static struct sprd_clk_common *ums312_pmu_gate_clks[] = {
...
static struct clk_hw_onecell_data ums312_pmu_gate_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_pmu_gate_desc = {
	.clk_clks	= ums312_pmu_gate_clks,
	.num_clk_clks	= ARRAY_SIZE(ums312_pmu_gate_clks),
	.hw_clks        = &ums312_pmu_gate_hws,
};
...
static struct sprd_clk_common *ums312_g0_pll_clks[] = {
	/* address base is 0x32390000 */
	&dpll0.common,
};

static struct clk_hw_onecell_data ums312_g0_pll_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_g0_pll_desc = {
	.clk_clks	= ums312_g0_pll_clks,
	.num_clk_clks	= ARRAY_SIZE(ums312_g0_pll_clks),
	.hw_clks	= &ums312_g0_pll_hws,
};
...
static struct sprd_clk_common *ums312_g2_pll_clks[] = {
	/* address base is 0x323B0000 */
	&mpll1.common,
};

static struct clk_hw_onecell_data ums312_g2_pll_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_g2_pll_desc = {
	.clk_clks	= ums312_g2_pll_clks,
	.num_clk_clks	= ARRAY_SIZE(ums312_g2_pll_clks),
	.hw_clks	= &ums312_g2_pll_hws,
};
...
static struct sprd_clk_common *ums312_g3_pll_clks[] = {
...
static struct clk_hw_onecell_data ums312_g3_pll_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_g3_pll_desc = {
	.clk_clks	= ums312_g3_pll_clks,
	.num_clk_clks	= ARRAY_SIZE(ums312_g3_pll_clks),
	.hw_clks	= &ums312_g3_pll_hws,
};
...
static struct sprd_clk_common *ums312_gc_pll_clks[] = {
...
static struct clk_hw_onecell_data ums312_gc_pll_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_gc_pll_desc = {
	.clk_clks	= ums312_gc_pll_clks,
	.num_clk_clks	= ARRAY_SIZE(ums312_gc_pll_clks),
	.hw_clks	= &ums312_gc_pll_hws,
};
...
static struct sprd_clk_common *ums312_apahb_gate[] = {
...
static struct clk_hw_onecell_data ums312_apahb_gate_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_apahb_gate_desc = {
	.clk_clks	= ums312_apahb_gate,
	.num_clk_clks	= ARRAY_SIZE(ums312_apahb_gate),
	.hw_clks	= &ums312_apahb_gate_hws,
};
...
static SPRD_COMP_CLK_DATA(ap_uart1, "ap-uart1", ap_uart_parents,
			  0x28, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(ap_uart2, "ap-uart2", ap_uart_parents,
			  0x2c, 0, 2, 8, 3, 0);
...
static SPRD_COMP_CLK_DATA(ap_i2c2, "ap-i2c2", i2c_parents,
			  0x38, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(ap_i2c3, "ap-i2c3", i2c_parents,
			  0x3c, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(ap_i2c4, "ap-i2c4", i2c_parents,
			  0x40, 0, 2, 8, 3, 0);
...
static SPRD_COMP_CLK_DATA(ap_spi0, "ap-spi0", spi_parents,
			  0x44, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(ap_spi1, "ap-spi1", spi_parents,
			  0x48, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(ap_spi2, "ap-spi2", spi_parents,
			  0x4c, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(ap_spi3, "ap-spi3", spi_parents,
			  0x50, 0, 2, 8, 3, 0);
...
static SPRD_COMP_CLK_DATA(ap_iis0, "ap-iis0", iis_parents,
			  0x54, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(ap_iis1, "ap-iis1", iis_parents,
			  0x58, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(ap_iis2, "ap-iis2", iis_parents,
			  0x5c, 0, 2, 8, 3, 0);
...
static SPRD_COMP_CLK_DATA(ap_sim, "ap-sim", sim_parents,
			  0x60, 0, 3, 8, 3, 0);
...
static SPRD_MUX_CLK_DATA(sdio0_2x, "sdio0-2x", sdio_parents,
			 0x7c, 0, 3, UMS312_MUX_FLAG);
static SPRD_MUX_CLK_DATA(sdio1_2x, "sdio1-2x", sdio_parents,
			 0x84, 0, 3, UMS312_MUX_FLAG);
static SPRD_MUX_CLK_DATA(emmc_2x, "emmc-2x", sdio_parents,
			 0x8c, 0, 3, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(dsi_apb, "dsi-apb", dsi_apb_parents,
			 0xa0, 0, 2, UMS312_MUX_FLAG);
...
static struct sprd_clk_common *ums312_ap_clks[] = {
...
static struct clk_hw_onecell_data ums312_ap_clk_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_ap_clk_desc = {
	.clk_clks	= ums312_ap_clks,
	.num_clk_clks	= ARRAY_SIZE(ums312_ap_clks),
	.hw_clks	= &ums312_ap_clk_hws,
};
...
static SPRD_COMP_CLK_DATA(aux0, "aux0", aux_parents,
			  0x228, 0, 5, 8, 4, 0);
static SPRD_COMP_CLK_DATA(aux1, "aux1", aux_parents,
			  0x22c, 0, 5, 8, 4, 0);
static SPRD_COMP_CLK_DATA(aux2, "aux2", aux_parents,
			  0x230, 0, 5, 8, 4, 0);
static SPRD_COMP_CLK_DATA(probe, "probe", aux_parents,
			  0x234, 0, 5, 8, 4, 0);
...
static SPRD_MUX_CLK_DATA(uart0, "uart0", uart_parents,
			 0x24c, 0, 3, UMS312_MUX_FLAG);
static SPRD_MUX_CLK_DATA(uart1, "uart1", uart_parents,
...
static SPRD_MUX_CLK_DATA(thm0, "thm0", thm_parents,
			 0x260, 0, 1, UMS312_MUX_FLAG);
static SPRD_MUX_CLK_DATA(thm1, "thm1", thm_parents,
			 0x264, 0, 1, UMS312_MUX_FLAG);
static SPRD_MUX_CLK_DATA(thm2, "thm2", thm_parents,
			 0x268, 0, 1, UMS312_MUX_FLAG);
static SPRD_MUX_CLK_DATA(thm3, "thm3", thm_parents,
			 0x26c, 0, 1, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(aon_i2c, "aon-i2c", aon_i2c_parents,
			 0x27c, 0, 3, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(aon_iis, "aon-iis", aon_iis_parents,
			 0x280, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(scc, "scc", scc_parents,
			 0x284, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(apcpu_dap, "apcpu-dap", apcpu_dap_parents,
			 0x288, 0, 3, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(apcpu_ts, "apcpu-ts", apcpu_ts_parents,
			 0x290, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(debug_ts, "debug-ts", debug_ts_parents,
			 0x294, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(djtag_tck, "djtag-tck", djtag_tck_parents,
			 0x2b4, 0, 1, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(aon_tmr, "aon-tmr", aon_tmr_parents,
			 0x2c0, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(aon_pmu, "aon-pmu", aon_pmu_parents,
			 0x2c8, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(debounce, "debounce", debounce_parents,
			 0x2cc, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(apcpu_pmu, "apcpu-pmu", apcpu_pmu_parents,
			 0x2d0, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(top_dvfs, "top-dvfs", top_dvfs_parents,
			 0x2d8, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(otg_ref, "otg-ref", otg_ref_parents,
			 0x2e0, 0, 1, UMS312_MUX_FLAG);
...
static SPRD_COMP_CLK_DATA(cssys, "cssys", cssys_parents,
			  0x2e4, 0, 3, 8, 2, 0);
static SPRD_DIV_CLK_HW(cssys_pub, "cssys-pub", &cssys.common.hw,
		       0x2e8, 8, 2, 0);
static SPRD_DIV_CLK_HW(cssys_apb, "cssys-apb", &cssys.common.hw,
		       0x2ec, 8, 3, 0);
...
static SPRD_MUX_CLK_DATA(ap_mm, "ap-mm", ap_mm_parents,
			 0x2f4, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(sdio2_2x, "sdio2-2x", sdio2_2x_parents,
			 0x2f8, 0, 3, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(dmc_ref, "dmc-ref", dmc_ref_parents,
			 0x304, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_MUX_CLK_DATA(emc, "emc", emc_parents,
			 0x30c, 0, 2, UMS312_MUX_FLAG);
...
static SPRD_COMP_CLK_DATA(usb, "usb", usb_parents,
			  0x310, 0, 3, 8, 2, 0);
...
static SPRD_MUX_CLK_DATA(pmu_26m, "pmu-26m", pmu_26m_parents,
			 0x318, 0, 1, UMS312_MUX_FLAG);

static struct sprd_clk_common *ums312_aon_apb[] = {
...
static struct clk_hw_onecell_data ums312_aon_apb_hws = {
	.hws	= {
		...
		[CLK_CSSYS_PUB]		= &cssys_pub.common.hw,
		...
		[CLK_DMC_REF_CLK]	= &dmc_ref.common.hw,
		[CLK_EMC]		= &emc.common.hw,
		[CLK_USB]		= &usb.common.hw,
		[CLK_26M_PMU]		= &pmu_26m.common.hw,
	},
	.num	= CLK_AON_APB_NUM,
};

static struct sprd_clk_desc ums312_aon_apb_desc = {
	.clk_clks	= ums312_aon_apb,
	.num_clk_clks	= ARRAY_SIZE(ums312_aon_apb),
	.hw_clks	= &ums312_aon_apb_hws,
};
...
static struct sprd_clk_common *ums312_aon_gate[] = {
...
static struct clk_hw_onecell_data ums312_aon_gate_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_aon_gate_desc = {
	.clk_clks	= ums312_aon_gate,
	.num_clk_clks	= ARRAY_SIZE(ums312_aon_gate),
	.hw_clks	= &ums312_aon_gate_hws,
};
...
static struct sprd_clk_common *ums312_audcpapb_gate[] = {
...
static struct clk_hw_onecell_data ums312_audcpapb_gate_hws = {
	.hws	= {
...
static const struct sprd_clk_desc ums312_audcpapb_gate_desc = {
	.clk_clks	= ums312_audcpapb_gate,
	.num_clk_clks	= ARRAY_SIZE(ums312_audcpapb_gate),
	.hw_clks	= &ums312_audcpapb_gate_hws,
};
...
static struct sprd_clk_common *ums312_audcpahb_gate[] = {
...
static struct clk_hw_onecell_data ums312_audcpahb_gate_hws = {
	.hws	= {
...
static const struct sprd_clk_desc ums312_audcpahb_gate_desc = {
	.clk_clks	= ums312_audcpahb_gate,
	.num_clk_clks	= ARRAY_SIZE(ums312_audcpahb_gate),
	.hw_clks	= &ums312_audcpahb_gate_hws,
};
...
static SPRD_COMP_CLK_DATA(gpu_core, "gpu-core", gpu_parents,
			  0x4, 4, 3, 8, 3, 0);

static SPRD_GATE_CLK_HW(gpu_mem_gate, "gpu-mem-gate", &gpu_eb.common.hw,
			0x8, BIT(0), 0, 0);

static SPRD_COMP_CLK_DATA(gpu_mem, "gpu-mem", gpu_parents,
			  0x8, 4, 3, 8, 3, 0);

static SPRD_GATE_CLK_HW(gpu_sys_gate, "gpu-sys-gate", &gpu_eb.common.hw,
			0xc, BIT(0), 0, 0);

static SPRD_DIV_CLK_HW(gpu_sys, "gpu-sys", &gpu_eb.common.hw,
		       0xc, 4, 3, 0);

static struct sprd_clk_common *ums312_gpu_clk[] = {
...
static struct clk_hw_onecell_data ums312_gpu_clk_hws = {
	.hws	= {
		[CLK_GPU_CORE_EB]	= &gpu_core_gate.common.hw,
		[CLK_GPU_CORE]		= &gpu_core.common.hw,
		[CLK_GPU_MEM_EB]	= &gpu_mem_gate.common.hw,
		[CLK_GPU_MEM]		= &gpu_mem.common.hw,
		[CLK_GPU_SYS_EB]	= &gpu_sys_gate.common.hw,
		[CLK_GPU_SYS]		= &gpu_sys.common.hw,
	},
	.num	= CLK_GPU_CLK_NUM,
};

static struct sprd_clk_desc ums312_gpu_clk_desc = {
	.clk_clks	= ums312_gpu_clk,
	.num_clk_clks	= ARRAY_SIZE(ums312_gpu_clk),
	.hw_clks	= &ums312_gpu_clk_hws,
};
...
static SPRD_COMP_CLK_DATA(sensor0, "sensor0", sensor_parents,
			  0x28, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(sensor1, "sensor1", sensor_parents,
			  0x2c, 0, 2, 8, 3, 0);
static SPRD_COMP_CLK_DATA(sensor2, "sensor2", sensor_parents,
			  0x30, 0, 2, 8, 3, 0);
...
static SPRD_MUX_CLK_DATA(fd, "fd", fd_parents,
			 0x3c, 0, 2, UMS312_MUX_FLAG);
...
static struct sprd_clk_common *ums312_mm_clk[] = {
...
static struct clk_hw_onecell_data ums312_mm_clk_hws = {
	.hws	= {
		[CLK_MM_AHB]	= &mm_ahb.common.hw,
		[CLK_MM_MTX]	= &mm_mtx.common.hw,
...
static struct sprd_clk_desc ums312_mm_clk_desc = {
	.clk_clks	= ums312_mm_clk,
	.num_clk_clks	= ARRAY_SIZE(ums312_mm_clk),
	.hw_clks	= &ums312_mm_clk_hws,
};
...
static struct sprd_clk_common *ums312_mm_gate_clk[] = {
...
static struct clk_hw_onecell_data ums312_mm_gate_clk_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_mm_gate_clk_desc = {
	.clk_clks	= ums312_mm_gate_clk,
	.num_clk_clks	= ARRAY_SIZE(ums312_mm_gate_clk),
	.hw_clks	= &ums312_mm_gate_clk_hws,
};
...
static struct sprd_clk_common *ums312_apapb_gate[] = {
...
static struct clk_hw_onecell_data ums312_apapb_gate_hws = {
	.hws	= {
...
static struct sprd_clk_desc ums312_apapb_gate_desc = {
	.clk_clks	= ums312_apapb_gate,
	.num_clk_clks	= ARRAY_SIZE(ums312_apapb_gate),
	.hw_clks	= &ums312_apapb_gate_hws,
};

static const struct of_device_id sprd_ums312_clk_ids[] = {
	{ .compatible = "sprd,ums312-pmu-gate",		/* 0x327e0000 */
	  .data = &ums312_pmu_gate_desc },
	{ .compatible = "sprd,ums312-g0-pll",		/* 0x32390000 */
	  .data = &ums312_g0_pll_desc },
	{ .compatible = "sprd,ums312-g2-pll",		/* 0x323b0000 */
	  .data = &ums312_g2_pll_desc },
	{ .compatible = "sprd,ums312-g3-pll",		/* 0x323c0000 */
	  .data = &ums312_g3_pll_desc },
	{ .compatible = "sprd,ums312-gc-pll",		/* 0x323e0000 */
	  .data = &ums312_gc_pll_desc },
	{ .compatible = "sprd,ums312-apahb-gate",	/* 0x20100000 */
	  .data = &ums312_apahb_gate_desc },
	{ .compatible = "sprd,ums312-ap-clk",		/* 0x20200000 */
	  .data = &ums312_ap_clk_desc },
	{ .compatible = "sprd,ums312-aonapb-clk",	/* 0x32080200 */
	  .data = &ums312_aon_apb_desc },
	{ .compatible = "sprd,ums312-aon-gate",		/* 0x327d0000 */
	  .data = &ums312_aon_gate_desc },
	{ .compatible = "sprd,ums312-audcpapb-gate",	/* 0x3350d000 */
	  .data = &ums312_audcpapb_gate_desc },
	{ .compatible = "sprd,ums312-audcpahb-gate",	/* 0x335e0000 */
	  .data = &ums312_audcpahb_gate_desc },
	{ .compatible = "sprd,ums312-gpu-clk",		/* 0x60100000 */
	  .data = &ums312_gpu_clk_desc },
	{ .compatible = "sprd,ums312-mm-clk",		/* 0x62100000 */
	  .data = &ums312_mm_clk_desc },
	{ .compatible = "sprd,ums312-mm-gate-clk",	/* 0x62200000 */
	  .data = &ums312_mm_gate_clk_desc },
	{ .compatible = "sprd,ums312-apapb-gate",	/* 0x71000000 */
	  .data = &ums312_apapb_gate_desc },
	{ }
};
MODULE_DEVICE_TABLE(of, sprd_ums312_clk_ids);

static int ums312_clk_probe(struct platform_device *pdev)
{
...
static struct platform_driver ums312_clk_driver = {
	.probe	= ums312_clk_probe,
	.driver	= {
		.name	= "ums312-clk",
		.of_match_table	= sprd_ums312_clk_ids,
	},
};
module_platform_driver(ums312_clk_driver);

MODULE_DESCRIPTION("Unisoc UMS312 Clock Driver");
