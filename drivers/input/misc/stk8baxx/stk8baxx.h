...
#define STK_IOCTL_SET_ENABLE		_IOW(STKDIR, 0x03, int)
#define STK_IOCTL_GET_ENABLE		_IOR(STKDIR, 0x04, int)
#define STK_IOCTL_SET_DELAY			_IOW(STKDIR, 0x05, int)
#define STK_IOCTL_GET_DELAY			_IOR(STKDIR, 0x06, int)
